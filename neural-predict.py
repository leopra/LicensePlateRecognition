...
loaded_model.load_weights("trained-letters.h5") # load weights
...
for folder in range(0,81) :
    filename = "E:\\LeoPrat\\Documents\\License Plate Recognition Git\\LicensePlateRecognition\\Project1\\char-found\\" + str(folder)
    print(filename)
    finallicense="" 
